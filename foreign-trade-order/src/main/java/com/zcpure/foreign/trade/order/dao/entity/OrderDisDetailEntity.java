...
public class OrderDisDetailEntity extends BaseEntity {
	...
	public static OrderDisDetailEntity form(OrderDetailEntity detailEntity, SupplierDTO supplier, Integer num) {
		...
		disDetailEntity.setGroupName(detailEntity.getGroupName());
		disDetailEntity.setGoodsCode(detailEntity.getGoodsCode());
		disDetailEntity.setGoodsName(detailEntity.getGoodsName());
		disDetailEntity.setBrandId(detailEntity.getBrandId());
		disDetailEntity.setBrandName(detailEntity.getBrandName());
		disDetailEntity.setModelId(detailEntity.getModelId());
		disDetailEntity.setModelName(detailEntity.getModelName());
		disDetailEntity.setCategoryId(detailEntity.getCategoryId());
		disDetailEntity.setCategoryName(detailEntity.getCategoryName());
		disDetailEntity.setCategoryLinkName(detailEntity.getCategoryLinkName());
